...
public interface IValrClientSpotApiInstantTrading
{
    ...
    Task<WebCallResult<ValrInstantTradeQuote>> GetQuoteAsync(string symbol, ValrOrderSide side, decimal quantity, long? receiveWindow = null, CancellationToken ct = default);
    ...
    Task<WebCallResult<ValrInstantTradeResponse>> PlaceInstantOrderAsync(string symbol, ValrOrderSide side, decimal quantity, long? receiveWindow = null, CancellationToken ct = default);
    ...
    Task<WebCallResult<ValrInstantTradeStatusResponse>> GetInstantOrderStatusAsync(string symbol, Guid id, long? receiveWindow = null, CancellationToken ct = default);
}