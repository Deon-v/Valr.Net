...
namespace Valr.Net.Interfaces.Clients.SpotApi
{
    public interface IValrClientSpotApiTrading
    {
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>The account information</returns>
        Task<WebCallResult<ValrPlaceOrderResponse>> GetOrderStatusAsync(string symbol, Guid id, long? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>The account information</returns>
        Task<WebCallResult<ValrPlaceOrderResponse>> GetOrderStatusAsync(string symbol, int clientOrderId, long? receiveWindow = null, CancellationToken ct = default);
